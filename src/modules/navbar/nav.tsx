        ...
        <nav className="flex flex-col justify-between h-full ">
          ...
          <div className="p-2 grow">
            <ul className="flex flex-col gap-1">
              ...
              <li
                className={`flex items-center gap-1 py-3 hover:bg-gray-50 px-2 rounded-md ${
                  currentLink === "/medications" && "text-blue-600 bg-[#e8f3ff]"
                }`}
              >
                {" "}
                <RiCapsuleLine />
          ...
          <div className="flex justify-between border-t  border-[#bdbdbd] py-3 px-2">
            <div className="grow text-[12px]">
              ...
              <span className="text-[#bdbdbd]">{user?.email}</span>
            </div>
            <button
              type="button"
              title="logout"
              className="hover:bg-gray-100 px-2 py-0.5 rounded-md text-red-500"
